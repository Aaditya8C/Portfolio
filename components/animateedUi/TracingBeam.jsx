      ...
      <div className="absolute -left-20">
        ...
        >
          <motion.div
            ...
            className="h-2 w-4 rounded-full border border-orange-300 bg-orange-300"
          />
        </motion.div>
        <svg
        ...
        >
          ...
          <defs>
            <motion.linearGradient
              ...
              y2={y2}
            >
              <stop stopColor="#F67B50" stopOpacity="0" />
              <stop stopColor="#FF8300" />
              <stop offset="0.325" stopColor="#F67B50" />
              <stop offset="1" stopColor="#FF8300" stopOpacity="0" />
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
