...
import Proj3 from "../public/Assets/tkFrontEnd.png";
...
import express from "../public/Assets/expresss.svg";
...
export const TkFrontEnd = Proj3;
export const NextLogo = next;
export const ReactLogo = react;
export const TailwindLogo = tailwind;
export const EtherLogo = ether;
export const SolidityLogo = solidity;
